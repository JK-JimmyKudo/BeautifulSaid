...
- (void)prepare{
    ...
    for (NSUInteger i = 0; i < 43; i++) {
        UIImage *image;
        if (i>9) {
            image = [UIImage imageNamed:[NSString stringWithFormat:@"loading_000%zd_100x100_", i]];
        }else{
            image = [UIImage imageNamed:[NSString stringWithFormat:@"loading_0000%zd_100x100_", i]];
        }
...
//    self.stateLabel.textColor = [PWColor appSupportColor];
