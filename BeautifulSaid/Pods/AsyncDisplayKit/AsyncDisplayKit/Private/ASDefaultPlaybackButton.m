...
{
    NSDictionary *parameter = (NSDictionary *)parameters;
    
  ASDefaultPlaybackButtonType buttonType = (ASDefaultPlaybackButtonType)[parameter[@"buttonType"] intValue];
  UIColor *color = parameter[@"color"];
